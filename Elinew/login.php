...
<div class="container">
		<div class="account">
		<h1 class="lang" key="Account">Account</h1>
		<div class="account-pass">
		<div class="col-md-8 account-top">
			<form name="Login" method="POST" action="valid/auth.php">
			<div> 	
				<span class="lang" key="Email">Email</span>
			...
			<button class="Submit_log lang" key="Login">LOGIN</button>
			</form>
			<?php
		...
		<div class="col-md-4 left-account ">
			...
			<div class="five">
			<h2>25% </h2><span class="lang" key="Discount">discount</span>
			</div>
			<a href="register.php" class="create lang" key="Create">Create an account</a>
<div class="clearfix"> </div>
		</div>
	<div class="clearfix"> </div>
	</div>
